...
export default function Register() {
  ...
  const focusStyle = e => e.target.style.borderColor = 'rgba(226,75,74,0.6)'
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Join thousands of Papua New Guineans learning cybersecurity</p>
        ...
        <form onSubmit={handleRegister}>
          <div style={styles.fieldGroup}>
            ...
            <input style={styles.input} type="text" value={username} onChange={e => setUsername(e.target.value)} required placeholder="Your display name" onFocus={focusStyle} onBlur={blurStyle} />
          </div>
          <div style={styles.fieldGroup}>
            <label style={styles.label}>Email address</label>
            <input style={styles.input} type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="you@example.com" onFocus={focusStyle} onBlur={blurStyle} />
          </div>
          <div style={styles.fieldGroup}>
            <label style={styles.label}>Password</label>
            <input style={styles.input} type="password" value={password} onChange={e => setPassword(e.target.value)} required placeholder="At least 6 characters" onFocus={focusStyle} onBlur={blurStyle} />
          </div>
          <button
            style={styles.btn}
            type="submit"
        ...
        <div style={styles.features}>
          {['100% free', 'No credit card', 'English & Tok Pisin', 'PNG scam alerts'].map((f, i) => (
